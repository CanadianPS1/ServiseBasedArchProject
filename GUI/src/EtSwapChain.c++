...
namespace et{
    ...
    VkResult EtSwapChain::acquireNextImage(uint32_t *imageIndex){
    ...
    VkResult EtSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
    ...
    void EtSwapChain::createSwapChain(){
    ...
    void EtSwapChain::createImageViews() {
    ...
    void EtSwapChain::createRenderPass(){
    ...
    void EtSwapChain::createFramebuffers(){
    ...
    void EtSwapChain::createSyncObjects(){
    ...
    VkPresentModeKHR EtSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes){
    ...
    VkExtent2D EtSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
    ...
    VkFormat EtSwapChain::findDepthFormat(){
